...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "properties"; version = "0.0.1"; };
