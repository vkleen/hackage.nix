...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!(compiler.isGhc && (compiler.version).lt "8.0" || compiler.isGhcjs && true)) ((pkgs.lib).optionals (system.isWindows) ((pkgs.lib).optional (system.isI386) (pkgs."gcc" or (sysDepError "gcc"))));
        buildable = true;
        };
      tests = {
        "check-foundation" = {
