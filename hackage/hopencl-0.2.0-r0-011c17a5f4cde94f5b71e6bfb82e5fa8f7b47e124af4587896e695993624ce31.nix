...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (!system.isOsx) (pkgs."OpenCL" or (sysDepError "OpenCL")));
        frameworks = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (system.isOsx) (pkgs."OpenCL" or (sysDepError "OpenCL")));
        build-tools = [
