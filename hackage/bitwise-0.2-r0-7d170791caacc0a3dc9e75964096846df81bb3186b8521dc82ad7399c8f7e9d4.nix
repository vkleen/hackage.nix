    ...
    components = {
      "library" = {
        depends = ((([
          ...
          ] ++ (pkgs.lib).optional (compiler.isHugs && true) (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.4") (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.4" && (compiler.isGhc && (compiler.version).lt "7.8")) (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.8") (hsPkgs."base" or (buildDepError "base"));
        buildable = true;
        };
      tests = {
        "bitwise-testsuite" = {
