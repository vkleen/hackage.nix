...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "type-map"; version = "0.1.3.0"; };
      license = "MIT";
