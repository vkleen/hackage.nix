...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "streaming"; version = "0.1.4.4"; };
