...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "Agda"; version = "2.6.0.1"; };
    ...
    components = {
      "library" = {
        depends = (((((((([
          ...
          ]) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.0" && (compiler.isGhc && (compiler.version).lt "8.4")) (hsPkgs."transformers" or (buildDepError "transformers"))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).lt "8.0") [
