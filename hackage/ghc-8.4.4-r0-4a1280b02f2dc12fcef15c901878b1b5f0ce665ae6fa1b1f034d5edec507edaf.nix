    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (!(system.isLinux && system.isX86_64 && (compiler.isGhc && (compiler.version).eq "8.4.4"))) (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optional (!flags.buildable) (hsPkgs."base" or (buildDepError "base"))) ++ (if system.isWindows
