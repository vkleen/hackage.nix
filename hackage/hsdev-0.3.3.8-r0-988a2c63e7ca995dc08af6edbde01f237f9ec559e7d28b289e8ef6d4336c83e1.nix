...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, config, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "hsdev"; version = "0.3.3.8"; };
    ...
    components = {
      "library" = {
        depends = ((((((([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.8" && (compiler.isGhc && (compiler.version).lt "8.9")) (hsPkgs."haddock-api" or (buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6" && (compiler.isGhc && (compiler.version).lt "8.7")) (hsPkgs."haddock-api" or (buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.4" && (compiler.isGhc && (compiler.version).lt "8.5")) (hsPkgs."haddock-api" or (buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.2" && (compiler.isGhc && (compiler.version).lt "8.3")) (hsPkgs."haddock-api" or (buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.0" && (compiler.isGhc && (compiler.version).lt "8.2")) (hsPkgs."haddock-api" or (buildDepError "haddock-api")))) ++ (pkgs.lib).optional (flags.hlint) (hsPkgs."hlint" or (buildDepError "hlint"));
        buildable = true;
        };
      exes = {
        "hsdev" = {
